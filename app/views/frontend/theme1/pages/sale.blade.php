				...
				<div class="ser-main">
					...
					<div class="ser-grid">
						<div class="ser-grid-list">
							<a href="details.html"><img src="web/images/icon1.png" alt=""></a>
						...
						<div class="ser-grid-list">
							<a href="details.html"><img src="web/images/icon2.png" alt=""></a>
						...
						<div class="ser-grid-list">
							<a href="details.html"><img src="web/images/icon3.png" alt=""></a>
					...
					<div class="ser-grid">
						<div class="ser-grid-list">
							<a href="details.html"><img src="web/images/icon4.png" alt=""></a>
							<h5><a href="details.html">100% look book</a></h5>
							<p class="para">It is a long established fact that a reader will be distracted by the page when looking at its layout.</p>
						</div>
						<div class="ser-grid-list">
							<a href="details.html"><img src="web/images/icon5.png" alt=""></a>
							<h5><a href="details.html">authentic products</a></h5>
							<p class="para"> The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters.</p>
						</div>
						<div class="ser-grid-list">
							<a href="details.html"><img src="web/images/icon6.png" alt=""></a>
