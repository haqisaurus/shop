        ...
        <div class="row">
            <div class="col-md-5">
                <div class="btn-group" role="group" aria-label="...">
                    <a href="{{ url('add-supplier') }}" class="btn btn-default"><span class="glyphicon glyphicon-plus-sign"></span> New data</a>
            ...
            <table class="table table-bordered table-hover table-striped">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>/index.html</td>
                        <td>1265</td>
                        <td><a href="#" class="btn btn-warning btn-xs"><span class="glyphicon glyphicon-pencil"></span> Edit</a> | <a href="#" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-trash"></span> Delete</a></td>
                    </tr>
                    <tr>
                        <td><input type="checkbox"></td>
                        <td>/about.html</td>
