                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <span class="task-item">
                                                    CPU Usage (25 - 32 cpus)<small class="pull-right text-muted">40%</small>
                                                    <div
                                                ...
                                                <span>
                                                    Memory Usage (2.5GB)<small class="pull-right text-muted">60%</small>
                                                    <div
                                                        class="progress progress-sm">
                                                        <div role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"
                                                ...
                                                <span>
                                                    Disk Usage (C:\ 120GB , D:\ 430GB)<small class="pull-right text-muted">55%</small>
                                                    <div
                                                        class="progress progress-sm">
                                                ...
                                                <span>
                                                    Domain (2/5)<small class="pull-right text-muted">66%</small>
                                                ...
                                                <span>
                                                    Database (90/100)<small class="pull-right text-muted">90%</small>
                                                    <div
                                                        class="progress progress-sm">
                                                ...
                                                <span>
                                                    Email Account (25/50)<small class="pull-right text-muted">50%</small>
                                                    <div
                                                        class="progress progress-sm">
                                                        <div role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"
                                ...
                                <div class="portlet box">
                                    ...
                                    <div class="portlet-body">
                                        <div class="chat-scroller">
                                            <ul class="chats">
                                                <li class="in">
                                                    {{ HTML::image("admin/images/avatar/48.jpg", "Logo", array('class' => "avatar img-responsive")) }}
                                        ...
                                        <div class="profile">
                                            <div style="margin-bottom: 15px" class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-4 text-center">
                                                    <figure>
                                                        {{ HTML::image("admin/images/avatar/48.jpg", "Logo", array('class' => "img-responsive img-circle", "style" => "display: inline-block")) }}
