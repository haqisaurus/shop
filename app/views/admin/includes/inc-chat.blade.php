                ...
                <div id="chat-form" class="fixed">
                    <div class="chat-inner">
                        <h2 class="chat-header">
                            ...
                            </i></a><i class="fa fa-user"></i>&nbsp; Chat &nbsp;<span class="badge badge-info">3</span>
                        </h2>
                    ...
                    <div id="chat-box" style="top: 400px">
                        ...
                        <div class="chat-content">
                            <ul class="chat-box-body">
                                <li>
                                    <p>
                                        {{ HTML::image("admin/images/avatar/128.jpg", "Logo", array('class' => "avt")) }}
                                ...
                                <li class="odd">
                                    <p>
                                        {{ HTML::image("admin/images/avatar/48.jpg", "Logo", array('class' => "avt")) }}<span class="user">Swlabs</span><span
                                            class="time">09:33</span>
                                    </p>
                                    <p>
